...
window.onload = () => {
        ...
        <html lang="en">
            ...
            <body>
                <div style="text-align: center; padding: 5%">
                    <img src="./imgs/pic.JPG" style="max-width: 80%;height:auto;" id="home-img-mo">
                </div>
                ...
                <div style="text-align: center; padding: 1%;">
                    <a href="https://discord.com/oauth2/authorize?client_id=755524223820103803&permissions=124992&scope=bot"><img src="./imgs/minesweeper.png" style="max-width: 75%;height:auto;" id="project-ms-img-mo"></a>
                </div>
                <div class="project-sb-item">
                    <a href="https://github.com/ratokoko/mc-spongebob-plugin"><img src="./imgs/spongebob_plugin.png" style="max-width: 80%;height:auto;" id="project-sb-img-mo"></a>
                </div>
        ...
        <html lang="en">
            ...
            <body>
                <div id="home-container">
                    <div class="home-item">
                        <img src="./imgs/pic.JPG" style="max-width: 80%;height:auto;" id="home-img">
                    </div>
                    <div class="home-item">
                ...
                <div id="project-ms-container">
                    ...
                    <div class="project-ms-item">
                        <img src="./imgs/minesweeper.png" style="max-width: 75%;height:auto;" id="project-ms-img">
                    </div>
                </div>
                <div id="project-sb-container">
                    <div class="project-sb-item">
                        <img src="./imgs/spongebob_plugin.png" style="max-width: 90%;height:auto;" id="project-sb-img">
                    </div>
                    <div class="project-sb-item">
    ...
    if (rotate) {
        let constrain = 3000;
        let mouseOverContainerMS = document.getElementById("project-ms-container");
        let imgMS = document.getElementById("project-ms-img");
        let mouseOverContainerSB = document.getElementById("project-sb-container");
        let imgSB = document.getElementById("project-sb-img");
        let mouseOverContainerHO = document.getElementById("home-container");
        let imgHO = document.getElementById("home-img");
        ...
        mouseOverContainerMS.onmousemove = function(e) {
            let xy = [e.clientX, e.clientY];
            let position = xy.concat([imgMS]);

            window.requestAnimationFrame(function(){
                transformElement(imgMS, position);
            });
        };

        mouseOverContainerSB.onmousemove = function(e) {
            let xy = [e.clientX, e.clientY];
            let position = xy.concat([imgSB]);

            window.requestAnimationFrame(function(){
                transformElement(imgSB, position);
            });
        };

        mouseOverContainerHO.onmousemove = function(e) {
            let xy = [e.clientX, e.clientY];
            let position = xy.concat([imgHO]);

            window.requestAnimationFrame(function(){
                transformElement(imgHO, position);
            });
        };
    }
};